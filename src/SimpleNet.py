...
class MyNet(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(
            nn.Conv2d(1, 2, 9), nn.MaxPool2d(2), nn.SELU(),  # 2, 116, 116
            nn.Conv2d(2, 4, 9), nn.MaxPool2d(2), nn.SELU(),  # 4, 54, 54
            nn.Conv2d(4, 8, 7), nn.MaxPool2d(2), nn.SELU(),  # 8, 24, 24
            nn.Conv2d(8, 16, 7), nn.MaxPool2d(2), nn.SELU(),  # 16, 9, 9
            nn.Conv2d(16, 32, 5), nn.SELU(),  # 32, 5, 5
            nn.Conv2d(32, 64, 3), nn.SELU(),  # 64, 3, 3
        )

        self.l2 = nn.Sequential(
            nn.Linear(576, 128), nn.SELU(),
            nn.Linear(128, 32), nn.SELU(),
            nn.Linear(32, 8), nn.SELU(),
            nn.Linear(8, 2), nn.SELU(),
